...
def chat_with_rag(request: ChatRequest):
    ...
    try:
        ...
        # 临时模拟ES数据 - 用于测试
        if "安联美元" in request.question or "安联" in request.question:
            logger.info("使用模拟ES数据测试RAG功能")
            hits = [
                {
                    "_source": {
                        "content": "安联美元基金是一只专注于美元资产投资的基金产品，主要投资于美国股票、债券等美元计价的金融工具。该基金旨在为投资者提供美元资产的多元化投资机会，帮助分散投资风险。",
                        "knowledge_id": 1,
                        "knowledge_name": "安联美元基金介绍",
                        "description": "安联美元基金的基本信息和投资策略",
                        "tags": "基金,美元,投资,安联",
                        ...
                        "positions": [{"page": 1, "bbox": [100, 200, 500, 250]}]
                    },
                    "_score": 0.95
                },
                {
                    "_source": {
                        "content": "基金投资策略包括：1）股票投资：主要投资于美国大型蓝筹股和成长股；2）债券投资：投资于美国国债、企业债等固定收益产品；3）货币市场工具：投资于短期美元货币市场工具。",
                        "knowledge_id": 1,
                        "knowledge_name": "安联美元基金介绍",
                        "description": "安联美元基金的投资策略详解",
                        "tags": "基金,美元,投资策略,股票,债券",
                        "effective_time": "2024-01-01",
                        "source_file": "安联美元.pdf",
                        "page_num": 2,
                        "chunk_index": 2,
                        "bbox": [100, 300, 500, 350],
                        "positions": [{"page": 2, "bbox": [100, 300, 500, 350]}]
                    },
                    "_score": 0.88
                },
                {
                    "_source": {
                        "content": "风险提示：1）汇率风险：基金投资于美元资产，存在人民币与美元汇率波动的风险；2）市场风险：美国股市和债市波动可能影响基金净值；3）流动性风险：部分投资品种可能存在流动性不足的风险。",
                        "knowledge_id": 1,
                        "knowledge_name": "安联美元基金介绍",
                        "description": "安联美元基金的风险提示",
                        "tags": "基金,美元,风险,汇率,市场",
                        "effective_time": "2024-01-01",
                        "source_file": "安联美元.pdf",
                        "page_num": 3,
                        ...
                        "positions": [{"page": 3, "bbox": [100, 400, 500, 450]}]
                    },
                    "_score": 0.82
                }
            ]
